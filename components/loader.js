export const MyLoader = () => {
    return (
        <div className="w-full h-full absolute top-0 bg-white opacity-75 z-50">
            <span className="text-blue-400 opacity-75 top-1/2 my-0 mx-auto block relative w-0 h-0">
                <span className="flex justify-center h-24">
                    ...
                    <span className="absolute top-0 flex items-center justify-center rounded-full h-24 w-24 bg-blue-600">
